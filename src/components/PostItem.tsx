                ...
                <div className={styles.postItemInformation}>
                    ...
                    <div className={styles.postItemDetails}>
                        <p className="text-base text-zinc-500">
                            <span className="">Por </span> {autor}
                        </p>
                        <p className="text-base md:mx-4 text-zinc-500">
                            <span className=""></span> {formatDate(date)}
                        </p>
                    </div>
                    <p className="hidden">{content}</p>
                    <Link
                        href={`/${id_entrada}`}
                        className={`${styles.postItemButton} group`}
                        scroll={true}
                    >
                        Leer{" "}
                        <GrLinkNext
                            className={`${styles.postItemButtonIcon} group-hover:translate-x-4`}
                        />
                    </Link>
                </div>
            </div>
