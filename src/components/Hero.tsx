            ...
            >
                <CarouselContent className={`${styles.heroCarrusel} ml-0`}>
                    {posts.map((post, index) => (
                        <CarouselItem
                            key={index}
                            className={`${styles.heroCarrusel} pl-0 px-1 md:px-4`}
                        >
                            {isMobile ? (
                                <div className={styles.hero}>
                                    <div className={styles.heroMobileWrapper}>
                                        <Link
                                            href={`/${post.id_entrada}`}
                                            scroll={true}
                                        >
                                            <div
                                                className={`${styles.heroMobileImageContainer} group`}
                                            >
                                                <Image
                                                    src={post.portada}
                                                    alt={post.titulo}
                                        ...
                                        >
                                            ...
                                            <Link
                                                href={`/${post.id_entrada}`}
                                                className={`${styles.heroButton} group`}
                                                scroll={true}
                                            >
                                                Leer{" "}
                                                <GrLinkNext
                                                    className={`${styles.heroButtonIcon} group-hover:translate-x-4`}
                                                />
                                            </Link>
                                        </div>
                                    </div>
                                    ...
                                    <div className={styles.heroWrapper}>
                                        <div className={styles.heroInformation}>
                                            ...
                                            <div className={styles.heroDetails}>
                                                <p className="text-base mr-4 text-zinc-500">
                                                    <span className="">
                                                        Por
                                                    </span>{" "}
                                                    {post.autor}
                                        ...
                                        <div
                                            className={`${styles.heroImageContainer} group`}
                                        >
                                            <Link
                                                href={`/${post.id_entrada}`}
                                                scroll={true}
