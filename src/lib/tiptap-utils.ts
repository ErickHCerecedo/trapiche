...
export const MAX_FILE_SIZE = 50 * 1024 * 1024 // 50MB - Para imágenes 4K
...
export const handleImageUpload = async (
  ...
  try {
    ...
    // Si tienes folder específico para el blog
    formData.append('folder', 'trapiche-blog');
    
    // Configurar la subida con XMLHttpRequest para tracking de progreso
      ...
      xhr.addEventListener('load', () => {
        if (xhr.status === 200) {
          try {
            ...
            // Cloudinary devuelve la URL en response.secure_url
